...
<!--
![SCCS소개](https://github.com/chancehee/SCCS/assets/59447235/9cef2ab7-8e15-45d3-b3a3-12d511f4fa5c)
-->
...
## 💡 기획 의도
[UCC 보러가기](https://drive.google.com/file/d/1zQ6ZbG10IxmlrWx6YM7p6xpa3O9vmOkT/view?usp=sharing)  
...
### -> 1개의 환경에서 실전 코딩 테스트와 그룹 스터디를 진행할 수 있는 통합 플랫폼.
...
<table>
    ...
    <tr>
        <td align="center">그림판<br/></td>
        <td align="center">WebSocket<br/></td>
        <td align="center">WebRTC<br/></td>
        <td align="center">채점서버, 회원<br/></td>
        <td align="center">WebSocket<br/></td>
        <td align="center">CI/CD<br/></td>
    </tr>
</table>
